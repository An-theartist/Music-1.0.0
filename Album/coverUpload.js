...
async function uploadCover() {
  const files = fs.readdirSync(uploadFolderPath).filter(f => /\.(jpg|jpeg|png|webp)$/i.test(f));
  ...
  // Ghi vào file JSON
  fs.writeFileSync("album_cover.json", JSON.stringify(ipfsMap, null, 2));
  console.log(" Đã tạo file album_cover.json");
